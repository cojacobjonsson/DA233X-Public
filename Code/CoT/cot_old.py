...
def jsd_calculate_step(sess, generator, oracle, sample_window=200):
    real_s = []
    fake_s = []
    jsd = []
...
def main():
    ...
    #TODO: get seqlen from data, text_precess()
    ...
    vocab_size = 5000 #TODO: 10k? Same as seqgan
    ...
    # TODO: can remove the oracle model if using real data?
    ...
    val_data_loader.create_batches(eval_file) # use val or test set?
    ...
    for iter_idx in range(TOTAL_BATCH):
        ...
        if iter_idx % gen_data_loader.num_batch == 0:
            jsd = jsd_calculate_step(sess, generator, target_lstm)
...
#TODO: when evaluating/at end, use get_real_test_file (translate indices to words)